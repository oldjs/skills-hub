...
说句实话：这个项目基本是我和 AI 一起写的，心态很复杂。

一方面，我是真的怕。怕 AI 最终会让程序员这个职业消失，包括我自己。每次看着 Claude 几秒钟写出来的功能比我一小时写的还好，那种感觉很微妙——不是愤怒，是一种「我这些年学的东西是不是白费了」的焦虑。这种焦虑是真实的，我不想假装它不存在。

另一方面，我是真的爱用 AI 写代码。快感太强了。以前一个周末能搞定一个小功能就不错了，现在一个周末能搞出一整个项目。就像突然有了一个不会累、不会烦、随叫随到的搭档。我已经变成了我以前看不起的那种人——嘴上说「重要的是知道做什么，不是怎么写代码」。

所以讽刺的是：我一边害怕 AI 取代我，一边疯狂用 AI 干活。如果有一天 AI 真把程序员全替代了，至少我是爽过了。如果没有，那我也多写了很多代码。

这整个项目都是在 AI（主要是 Claude）的重度辅助下完成的。架构决策、代码实现、甚至 README 的部分内容——到处都有 AI 的痕迹。我不觉得这有什么丢人的。有一点害怕。但更多的是觉得，能有这些工具，挺好的。
